            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="slide-size item active">
                        <img src="../images/luxurious/a(9).jpg" style="width:100%;">
                    </div>
                    ...
                    <div class="slide-size item">
                        <img src="../images/luxurious/a(8).jpg" style="width:100%;">
                    </div>
                    <div class="slide-size item">
                        <img src="../images/luxurious/a(10).jpg" style="width:100%;">
                    </div>
                    <div class="slide-size item">
                        <img src="../images/luxurious/a(11).jpg"  style="width:100%;">
                    </div>
                </div>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-4">
            <div class="thumbnail">
                <img style="height: 500px" src="../images/luxurious/a%20(1).jpeg" alt="Fjords" style="width:100%">
                <div class="caption">
                    <h3>Single Bed Deluxe</h3>
                    <h4>Couples Choice</h4>
                    <p><b>Room No :303</b></p>
                    <p class="rate">Price&nbsp;:&nbsp;3000&nbsp;TK</p>
        ...
        <div class="col-md-4">
            <div class="thumbnail">
                <img style="height: 500px" src="../images/luxurious/a%20(1).jpg" alt="Fjords" style="width:100%">
                <div class="caption">
                    <h3>Single Bed Super Deluxe</h3>
                    <h4>Couples Choice</h4>
                    <p><b>Room No :403</b></p>
                    <p class="rate">Price&nbsp;:&nbsp;5500&nbsp;TK</p>
                    <div class="text btn btn-info">
        ...
        <div class="col-md-4">
            <div class="thumbnail">
                <img style="height: 500px" src="../images/luxurious/a%20(6).jpg" alt="Fjords" style="width:100%">
                <div class="caption">
                    <h3>Double Bed Super Deluxe</h3>
                    <h4>Family Choice</h4>
                    <p><b>Room No :603</b></p>
                    <p class="rate">Price&nbsp;:&nbsp;7500&nbsp;TK</p>
                    <div class="text btn btn-info">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="thumbnail">
                <img style="height:500px" src="../images/luxurious/a%20(4).jpg" alt="Fjords" style="width:100%">
                <div class="caption">
                    <h3>Double Bed Super Deluxe</h3>
                    <h4>Family Choice</h4>
                    <p><b>Room No :605</b></p>
                    <p class="rate">Price&nbsp;:&nbsp;6500&nbsp;TK</p>
                    <div class="text btn btn-info">
        ...
        <div class="col-md-4">
            <div class="thumbnail">
                <img style="height: 500px" src="../images/luxurious/a%20(5).jpg" alt="Fjords" style="width:100%">
                <div class="caption">
                    <h3>Single Bed Super Deluxe</h3>
                    <h4>Couples</h4>
                    <p><b>Room No :606</b></p>
                    <p class="rate">Price&nbsp;:&nbsp;3500&nbsp;TK</p>
                    <div class="text btn btn-info">
