...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-7">
            <img class="image" src="../images/luxurious/a%20(1).jpg">
        </div>
    </div>
</div>
...
<div class="juumbtron">
    <div class="conteiner-fluid">
        <div class="row">
            <div class="col-md-4">
                <div class="thumbnail">
                    <img style="height: 300px" src="../images/luxurious/a%20(1).jpg" alt="Fjords" style="width:100%">
                    <div class="caption">
            ...
            <div class="col-md-4">
                <div class="thumbnail">
                    <img style="height: 300px" src="../images/luxurious/drawing-room/2.jpg" alt="Fjords" style="width:100%">
                    <div class="caption">
            ...
            <div class="col-md-4">
                <div class="thumbnail">
                    <img style="height: 300px" src="../images/luxurious/bathroom/2.jpg" alt="Fjords" style="width:100%">
                    <div class="caption">
