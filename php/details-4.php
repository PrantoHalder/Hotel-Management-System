...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-7">
            <img class="image" src="../images/luxurious/a%20(3).jpg">
        </div>
    </div>
</div>
...
<div class="juumbtron">
    <div class="conteiner-fluid">
        <div class="row">
            <div class="col-md-4">
                <div class="thumbnail">
                    <img style="height: 300px" src="../images/luxurious/a%20(3).jpg" alt="Fjords" style="width:100%">
                    <div class="caption">
            ...
            <div class="col-md-4">
                <div class="thumbnail">
                    <img style="height: 300px" src="../images/luxurious/drawing-room/4.jpg" alt="Fjords" style="width:100%">
                    <div class="caption">
